pageextension 50110 pageextension50110 extends "Sales Credit Memo Statistics" 
{
  ...
  layout
  {
   ...
   trigger OnOpenPage();
    begin
        g_cdu.OnUpdateControlsCrMemo(Rec, TotalIRPFAmount, IRPFAmountText, IRPFTextVisible, IRPFAmountVisible, TotalIRPFVisible, TotalIRPFTextVisible, "Income Tax BaseVisible")
    end;
